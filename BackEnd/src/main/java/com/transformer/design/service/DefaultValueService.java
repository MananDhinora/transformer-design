...
public class DefaultValueService {
    ...
    @Autowired
    private DefaultValueRepositoryImpl defaultValueRepositoryImpl;
    ...
    public ResponseEntity<?> getValue(@PathVariable String valueType,
        ...
        try {
            List<DefaultValueData> defaultValueDocument = defaultValueRepository.findByUserId(userDocument.getId());
